...
export class BlogController {
    ...
    @Get()
    async findAll(@Query("limit",ParseIntPipe) limit:number, @Query("page",ParseIntPipe) page:number,@Query("userId") userId?:string){
    ...
    @UseGuards(AccessGuard)
    @Patch(":id")
    async update(@Param("id") blogId:string, @Body() body:UpdateBlogDto, @Request() request:RequestType){
